...
enum class SentimentCategory(val type: String, val annotation: String) {
  ...
  SocialProcess("Social process", "social"),
  Family("Social process", "family"),
  Friendly("Social process", "friend"),
  Human("Social process", "humans"),
  Affect("Affective Process", "affect"),
  PositiveEmotion("Affective process", "posemo"),
  NegativeEmotion("Affective process", "negemo"),
  Anxiety("Affective process - Negative Emotion", "anx"),
  Anger("Affective process - Negative Emotion", "anger"),
  Sadness("Affective process - Negative Emotion", "sad"),
