...
data class CloseInterval(
  ...
  override fun toJSON(): JsonObject = json {
    obj(
      "startToken" to this@CloseInterval.startToken,
      "endToken" to this@CloseInterval.endToken,
      "from" to this@CloseInterval.from.toJSON(),
      "to" to this@CloseInterval.to.toJSON()
    )
  }
}
