...
abstract class SingleMorphology(val pos: POS) {
  ...
  companion object {
     ...
     * @param oov whether the morphology has been automatically generated by the system (Out Of Vocabulary)
     * @param numericForm the numeric form in case the building morphology is a Number
     * @param allowDefaultValues allow to build the morphology without specifying its optional properties
     *                           (default = false)
     *
    ...
    operator fun invoke(lemma: String,
                        ...
                        allowDefaultValues: Boolean = false): SingleMorphology {
  ...
  /**
   * Whether this morphology has been automatically generated by the system (Out Of Vocabulary).
   */
  abstract val oov: Boolean
  ...
  open fun toJSON(): JsonObject {
    ...
    val jsonObject = json {
      obj(
        ...
        "oov" to this@SingleMorphology.oov,
